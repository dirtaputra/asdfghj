...
<body>
	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-stats ico-white"></i>Profile</h2>
	...
	<div id="wrapper">
		...
		<!--start: Container -->
    	<div class="container"> 
        <center><div class="title" style="margin-left: ;"><h3>Profile...</h3></div></center>
...
<td width="30">:</td>
<td width="550"><span>081235664089</span></td>
</tr>
<tr>
<td width="150">Instagram</td>
<td width="30">:</td>
<td width="550">@giacinta.arianne</td>
</tr>
<tr>
<td width="150">Sekolah</td>
<td width="30">:</td>
<td width="550">SMAK Kolese Santo Yusup Malang</td>
</tr>
<tr>
<td width="150">Kelas</td>
<td width="30">:</td>
<td width="550">11 MIA 5</td>
</tr>
<tr>
<td width="150">No Absen</td>
<td width="30">:</td>
<td width="550">17</td>
</tr>
</table>
